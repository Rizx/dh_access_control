...
namespace IO.Swagger.Model
{
        ...
        public partial class UserRequest :  IEquatable<UserRequest>, IValidatableObject
    {
        ...
        public UserRequest(long? id = default(long?), string username = default(string), string fullname = default(string), string role = default(string), string password = default(string), bool? active = default(bool?))
        {
            this.Id = id;
